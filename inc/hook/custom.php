...
if ( ! function_exists( 'university_hub_footer_copyright' ) ) :
	...
	function university_hub_footer_copyright() {
		...
		// Powered by content. // ! temporary hidden !
		...
		<div class="colophon-inner">
		    ...
		    <?php endif; ?>
			<!-- footer_menu_content and copyright_text have been swapped -->
		    <?php if ( ! empty( $copyright_text ) ) : ?>
			    <div class="colophon-column">
			    	<div class="copyright">
			    		<?php echo str_replace('%year%', date('Y'), $copyright_text); ?> <!-- Current year added -->
			    	</div><!-- .copyright -->
			    </div><!-- .colophon-column -->
		    <?php endif; ?>
