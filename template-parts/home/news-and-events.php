		...
		<div class="inner-wrapper">
						...
						<?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
							...
							<div class="news-post">
								...
								if ( has_post_thumbnail() ) : ?>
									<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( $image_size , array( 'class' => 'aligncenter' ) ); ?></a>
								<?php endif; ?>
			...
			<div class="recent-events">
				...
				<?php if ( $the_query->have_posts() ) : ?>
						...
						<?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
							...
							<div class="event-post">
								<div class="custom-entry-date">
									<?php // getting a display style from the customizer
						...
						<!-- additional link to the feed of posts of the selected category -->
