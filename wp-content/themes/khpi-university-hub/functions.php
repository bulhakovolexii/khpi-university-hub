...
function child_theme_enqueue_styles()
{
    ...
    wp_enqueue_style('academicons', get_stylesheet_directory_uri() . '/third-party/academicons/css/academicons.min.css', [], '1.9.4');
}
...
function fb_opengraph()
{
    ...
    if (is_single()) {
        ...
        if (has_post_thumbnail($post->ID)) {
            ...
            $img_src = $img_data ? $img_data[0] : get_stylesheet_directory_uri() . '/assets/images/opengraph_image.png';
        } else {
            $img_src = get_stylesheet_directory_uri() . '/assets/images/opengraph_image.png';
        }
