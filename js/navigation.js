    ...
    jQuery(document).ready(function ($) {
        ...
        function initMainNavigation(container) {
            ...
            var dropdownToggle = $('<button />', {
                ...
                $('<span />', {
                    ...
                    text: universityHubOptions.screenReaderText.expand,
                })
            )
            ...
            container.find('.dropdown-toggle').on('click', function (e) {
                ...
                screenReaderSpan.text(
                    screenReaderSpan.text() === universityHubOptions.screenReaderText.expand
                        ? universityHubOptions.screenReaderText.collapse
                        : universityHubOptions.screenReaderText.expand
                )
            })
        }
            ...
            function toggleFocusClassTouchScreen() {
                if (window.innerWidth >= 910) {
                    ...
                    siteNavigation
                        ...
                        .on('touchstart.universityHub', function (e) {
        ...
        ;(function () {
            ...
            topMenuToggle.on('click.universityHub', function () {
                // jscs:disable
                $(this)
                    .add(topSiteNavigation)
                    .attr('aria-expanded', $(this).add(topSiteNavigation).attr('aria-expanded') === 'false' ? 'true' : 'false')
                // jscs:enable
            })
